...
if($inc ){
		...
		if( isset($_POST["nombreCategoria"]) and isset($_POST["codigoCategoria"]) and isset($_POST["tipoCategoria"] )){
			$nombre = $_POST["nombreCategoria"];
			$codigo = $_POST["codigoCategoria"];
            $tipo = $_POST["tipoCategoria"];
		    $consulta = "UPDATE `categorias` SET `nombre_categoria` = '$nombre', tipo = '$tipo' WHERE id= '$codigo';
            ";
		...
		if ( mysqli_query($conexion, $consulta) ){
                ...
                echo '<h1>Categoria editada exitosamente</h1>';
