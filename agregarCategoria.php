...
<body>
    <?php
        ...
        if($inc) {
            ...
            if(isset($_POST["nombreCategoria"]) && isset($_POST["tipoCategoria"])) {

                    $tipo = $_POST["tipoCategoria"];
                    $nombre = $_POST["nombreCategoria"];
                    $consulta = "INSERT INTO `categorias` (`id`, `nombre_categoria`, `tipo`) VALUES (NULL, '$nombre', '$tipo')";
                    if(mysqli_query($conexion,$consulta)) {
                        echo '<div class="msj-cat-edited-container">';
                                
                        echo '<h1>Categoria creada exitosamente</h1>';
